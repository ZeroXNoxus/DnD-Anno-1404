...
function getTable(tab){
    ...
    $.ajax({
        ...
        var form = "<div class='row'><div class='col-12'><form class='dialog-form' data-tab='"+tab+"' method='post'><div class='form-group col-12'><h4 class='header'>Datensatz anlegen für Tabelle '"+tab+"'</h4><div class='row'>";
        var i = 0;
        while(i<response.content.length){
            ...
            for(x in obj){
                ...
                table += "<td>";
                if(is_pri){
                    table += "<input type='text' class='is_pri' data-tab='"+tab+"' data-name='"+x+"' data-title='"+x+": "+value+"' title='"+x+": "+value+"' value='"+value+"' />";
                } else{ 
                    table += "<input type='text' data-tab='"+tab+"' data-name='"+x+"' data-title='"+x+": "+value+"' title='"+x+": "+value+"' value='"+value+"' />";
                }
                if(i == 0){
                    if(is_pri){
